...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_A,    KC_CAPS,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,        KC_ENT,
        MO(_ARR),    KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,KC_RALT,
        KC_NO,  KC_LCTL,        KC_LGUI,        KC_SPC, KC_LALT,KC_SPC, KC_RGUI,                                        KC_RCTRL
    ),
    [_ARR] = LAYOUT(
        KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_MPRV,	KC_MNXT,	KC_MPLY,	KC_VOLD,	KC_VOLU,
